...
const config = {
  ...
  url: 'https://frankzhaopeng.github.io/',
  baseUrl: '/FeatureProbeDocs/',
  onBrokenLinks: 'throw',
  ...
  organizationName: 'frankzhaopeng', // Usually your GitHub org/user name.
  projectName: 'FeatureProbeDocs', // Usually your repo name.
